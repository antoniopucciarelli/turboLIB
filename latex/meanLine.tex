...
\subsection{Main design quantities}
	\begin{frame}{Graph analysis: $\chi$ \& $r_{mean}$}
		\begin{figure}
			\centering
			\includegraphics[width=\textwidth]{figures/rMeanChi.png}
		\end{figure}
	\end{frame}
	\begin{frame}{Graph analysis: $\alpha$ \& $\beta$}
		\begin{columns}
			\column{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=\textwidth]{figures/betaAngles.png}
				\end{figure}
			\column{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=\textwidth]{figures/alphaAngles.png}
				\end{figure}
	\end{frame}
